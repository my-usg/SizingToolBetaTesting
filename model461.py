...
# ── page config ───────────────────────────────────────────────────────────────
st.set_page_config(page_title="Model 441/461 Sizing Tool", page_icon="⚙️", layout="wide", initial_sidebar_state="collapsed")
...
def table_to_df(table):
    ...
    return pd.DataFrame(rows, columns=["Applicable Models", "Body", "Orifice", "Qmax (CFH)", "Qmin (CFH)", "Will Reg Work"])
                ...
                if ok461:
                    ...
                    try:
                        ...
                        pdf_buf = build_summary_pdf(
                            ...
                            adjustments=adj,
                            tool_name="Model 441/461 Sizing Tool",
                        )
                        st.download_button(
