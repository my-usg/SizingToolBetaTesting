...
def run_tool(
    ...
    g = globals()
    g["inlet_input"]   = inlet_input
    g["outlet_input"]  = outlet_input
    g["flow_rate"]     = flow_rate
    g["min_flow"]      = min_flow
    g["maop"]          = maop
    g["pipesize_input"]= pipesize_input
    g["opp_type"]      = opp_type
    g["partial"]       = partial
    g["irv_input"]     = irv_input
    g["irv_lim"]       = irv_input - outlet_input if irv_input else 0
    g["oversizeby"]    = oversizeby
    g["gastypemult"]   = gastypemult
