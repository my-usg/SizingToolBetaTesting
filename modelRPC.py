...
st.markdown("<style>[data-testid='stSidebarCollapseButton'],[data-testid='stSidebarCollapsedControl'],[data-testid='collapsedControl']{display:none}</style><h1>⚙️ Model 243-RPC Sizing Tool</h1>", unsafe_allow_html=True)
...
_code   = "".join(_lines[:628])   # stop before INPUT section
