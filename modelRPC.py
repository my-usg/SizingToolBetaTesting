...
with _loadgas:
    ...
    pload_pct = 0
    if higheff == "Yes":
        pload_pct = st.slider("% of total load high-efficiency appliances", 0, 100, 100, help="Program will select a regulator that has capacity for double the load feeding high-efficiency equipment")
