...
# ── page config ───────────────────────────────────────────────────────────────
st.set_page_config(page_title="Model 121/122 Sizing Tool", page_icon="⚙️", layout="wide", initial_sidebar_state="collapsed")

st.markdown("<style>[data-testid='stSidebarCollapseButton'],[data-testid='stSidebarCollapsedControl'],[data-testid='collapsedControl']{display:none}</style><h1>Model 121/122 Sizing Tool</h1>", unsafe_allow_html=True)
...
with _v4:
    min_flow_raw = st.number_input("Min gas load / flow rate", min_value=0, max_value=10000000000, value=0, step=50, format="%d", help="Not required: default 0 (enter 0 to use max flow)")
...
with _design:
    ...
    _pipe_options = ["N/A", '3/4"', '1"', '1-1/4"', '1-1/2"', '2"', '2-1/2"', '3"']
        ...
        with st.spinner("Sizing regulator…"):
            try:
                ...
                summary = {
                    ...
                    "Percent Load Feeding High-Efficiency Appliance": f"{pload_pct}%" if higheff == "Yes" else "N/A",
                ...
                if apply121:
                    ...
                    try:
                        ...
                        pdf_buf = build_summary_pdf(
                            ...
                            adjustments=adj,
                            tool_name="Model 121/122 Sizing Tool",
                        )
                        st.download_button(
